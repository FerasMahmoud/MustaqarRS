...
const metadataByLocale = {
  en: {
    title: 'Qurtubah Luxury Homes',
    description: 'Looking for luxury studio rentals in Riyadh? Qurtubah Luxury Homes offers premium furnished studios from SAR 200/night with WiFi, kitchen, and daily cleaning. Book online or via WhatsApp.',
  ...
  ar: {
    title: 'منازل قرطبة الفاخرة',
    description: 'تبحث عن استوديوهات فاخرة للإيجار في الرياض؟ منازل قرطبة الفاخرة تقدم استوديوهات مفروشة بالكامل من 200 ريال/ليلة مع واي فاي ومطبخ وتنظيف يومي. احجز عبر الإنترنت أو واتساب.',
...
export async function generateMetadata({
  ...
  return {
    title: {
      default: meta.title,
      template: locale === 'ar' ? `%s | منازل قرطبة` : `%s | Qurtubah Homes`,
    },
    description: meta.description,
    keywords: meta.keywords,
    authors: [{ name: 'Qurtubah Luxury Homes' }],
    creator: 'Qurtubah Luxury Homes',
    publisher: 'Qurtubah Luxury Homes',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Qurtubah Luxury Homes - Premium Studio Rentals in Riyadh',
        },
      ],
    },
    // Twitter Card
